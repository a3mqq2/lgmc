...
<head>
  ...
  <title>تعذر تسجيل عضويتك في نظام النقابة الالكتروني</title>
  <style>
    body {
...
<body>
  <div class="container">
    ...
    <div class="reason">
        <strong>سبب الرفض:</strong> {{ $doctor->edit_note }}
    </div>

    <p>يمكنك تسجيل الدخول على موقع النقابة وتعديل بياناتك كي نتمكن من المراجعه عليها مجدداََ </p>
    ...
    <p class="footer">إذا كنت بحاجة إلى مساعدة، يرجى التواصل معنا عبر البريد الإلكتروني:  
        <a href="mailto:info@lgmc.org.ly">info@lgmc.org.ly</a>
    </p>
