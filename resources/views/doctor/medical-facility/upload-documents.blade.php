...
<div class="container upload-card">
  <div class="card shadow-sm">
    <div class="card-header bg-primary text-white text-center">
      <h5 class="mb-0 text-light"><i class="fas fa-building me-1"></i> رفع مستندات المنشأة</h5>
      <small>{{ $medical_facility->name }} (ID: {{ $medical_facility->id }})</small>
    </div>
    <div class="card-body">
      @include('layouts.messages')
      <div class="row">
        @foreach($requiredFileTypes as $type)
          <div class="col-md-6 mb-4">
            ...
            <input
              ...
              class="filepond"
              name="file_{{ $type->id }}"
              data-medical-facility-id="{{ $medical_facility->id }}"
        ...
        const pond = FilePond.create(input, {
          ...
          server: {
            process: {
              ...
              ondata: fd => {
                fd.append('medical_facility_id', input.dataset.medicalFacilityId);
