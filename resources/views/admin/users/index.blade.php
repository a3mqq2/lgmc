                        ...
                        <table class="table table-hover table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th class="bg-light">الأدوار (Roles)</th>
                                    <th class="bg-light">الصلاحيات الإضافية (Permissions)</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @else
                                            <span class="text-muted">لا يوجد دور معين</span>
                                        @endif
                                    </td>

                                    {{-- Additional Permissions Column (excluding those from roles) --}}
                                    <td>
                                        @php
                                            // permissions direct to user
