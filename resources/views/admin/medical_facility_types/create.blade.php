...
@section('title', 'إنشاء نوع مرفق طبي جديد')
@section('content')
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title text-light">إنشاء نوع مرفق طبي جديد</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route(get_area_name().'.medical-facility-types.store') }}" method="POST">
                        @csrf
